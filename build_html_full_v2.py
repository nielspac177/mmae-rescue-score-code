...
<div class="lede">
Among 214 consecutive MMA embolization procedures for chronic subdural hematoma, 36 (16.8%) led to rescue surgery. We built two primary knowledge-driven integer risk scores plus three sensitivity models. The primary 7-point Model 1 reaches AUC 0.70 (optimism-corrected); the simplified 4-point Model 2 reaches AUC 0.64. Sensitivity models: Model 3 (5-point co-author derivation) AUC 0.70; data-driven Model 4 (lasso, EPV-5 cap, evaluated under three class-imbalance modes) cross-validated AUC 0.66 (95% CI 0.56–0.75). A Model 1 score of ≥4 separates an 8.6% rescue cohort from a 36.5% rescue cohort, a 4.2-fold difference. SDH volume ≥100 mL and age are the two strongest individual contributors.
</div>
...
<h2>5 · Conclusion</h2>
<p>A simple 7-point pre-procedural knowledge-driven score discriminates rescue surgery after MMA embolization for chronic subdural hematoma with an optimism-corrected AUC of 0.70. A score of ≥4 identifies a patient cohort with a 4.2-fold higher rescue rate than the rest of the population. SDH volume ≥100 mL and age are the two strongest individual contributors. A data-driven sensitivity Model 4 (lasso, with three class-imbalance modes) reaches an essentially identical cross-validated AUC, confirming that the parsimonious knowledge-driven form is not sacrificing accuracy at this event count. External validation is required before clinical adoption.</p>
