...
<p>The 214 patients had a mean age of 73.4 years (20.6% &lt;65, 47.7% 65–80, 31.8% &gt;80). One in four (25.7%) was on anticoagulation and just over a third (36.4%) on antiplatelet therapy. SDH volume reached ≥100 mL in 29.0%, platelets fell below 150 ×10⁹/L in 20.6%, and 59.8% had a focal neurological deficit at the time of embolization. Anterior and posterior branches were both embolized in 53.7%. Thirty-six patients (16.8%) went on to rescue surgery.</p>
<p><b>Table 1.</b> Baseline characteristics by rescue status.</p>
{df_table(table1)}

<h3>Univariable associations</h3>
<p>On univariable analysis, SDH volume ≥100 mL was the only score variable to reach statistical significance (OR 2.30, 95% CI 1.10–4.80; P = 0.027). Antiplatelet therapy was borderline (OR 1.97, 95% CI 0.95–4.05; P = 0.067). The remaining score variables — age &gt;80 (OR 1.68), platelets &lt;150 (OR 1.93), anticoagulation (OR 1.57), and dual-branch embolization (OR 1.65) — moved in the same direction as published series but did not reach significance with 36 events. Focal neurological deficit at presentation was non-significant on univariable analysis (OR 1.07, 95% CI 0.51–2.22; P = 0.86).</p>
{img("fig4_forest")}
...
<p>Focal neurological deficit at presentation is part of every published MMA-embolization predictor list and is consistently associated with worse outcomes in the burr-hole literature. In our cohort, however, focal deficit was non-significant on univariable analysis (OR 1.07, 95% CI 0.51–2.22; P = 0.86) and on multivariable analysis (Model 1 adjusted OR 0.80, 95% CI 0.36–1.78; P = 0.58). The Akaike information criterion was 1.7 units higher with the variable than without, and the lasso-based Model 4 did not retain it at the chosen penalty. Cross-validated AUC differed by less than 0.02 between scores with and without the variable. The likeliest explanation is that focal deficit, while clinically meaningful at the bedside, is heavily collinear with SDH volume, midline shift, and pre-procedure mRS in this cohort and contributes little independent information once those imaging and neurological-status variables are already in the model. The variable was therefore excluded from the primary scores for parsimony; focal-included variants of Models 1–3 are reported as a sensitivity analysis to allow direct comparison.</p>
