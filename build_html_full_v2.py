...
<p>The second finding is less straightforward. Patients who came to embolization without a focal neurological deficit had three times the rescue rate of patients who did. The most plausible explanation is selection: a patient with a 120 mL hematoma and a hemiparesis goes to the operating room first; a patient with the same hematoma and no deficit gets embolized and watched. The asymptomatic-but-radiographically-large group is exactly the group whose hematoma can grow unpredictably in the weeks after embolization, and exactly the group most likely to come back for rescue. This pattern is consistent with the treatment-effect-heterogeneity analysis recently reported by Chen and colleagues.<sup>18</sup> If reproduced externally, it argues for tighter post-procedural imaging surveillance specifically in the asymptomatic-but-large subgroup.<sup>5,8,9</sup></p>
